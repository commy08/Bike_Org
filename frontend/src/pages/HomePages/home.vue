<template>
  <v-app dark>
    <section>
      <v-parallax src="https://www.filmhousecinema.com/sites/filmhousecinema.com/files/shows/2017/Mountain-3.jpg" height="600">
							...
							<svg>
								<defs>
									<mask id="mask" x="0" y="0" width="100%" height="100%">
										...
										<text id="title1" x="50%" y="30%" dy="1em" letter-spacing="0.02em">BIKE ORG</text>
									</mask>
								</defs>
